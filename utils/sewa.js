...
let setbot = JSON.parse(fs.readFileSync("./config.json"));
let devNumber = setbot;
...
const expiredCheck = (setya, _dir) => {
	setInterval(() => {
		...
		if (position !== null) {
			let txt = `Waktu Sewa Mu Telah Habis Silahkan Perpanjang Ke Owner Wa : https://wa.me/6285892935752`;
